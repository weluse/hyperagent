...
/**
 * POST to the resource's URL using the `loadAjax` module. By default
 * the following instance options are passed to the AJAX function:
 *
 * - headers
 * - username
 * - password
 ...
 *
 * Parameters:
 * - body: The data to place in the body of the request
 * - options:
 *   - force: defaults to false, whether to force a new request if the result is
 *   cached, i. e this resource is already marked as `loaded`.
 *   - ajax: optional hash of options to override the Resource AJAX options.
 ...
 * Returns a promise on the this Resource instance.
 */
Resource.prototype.post = function fetch(body, options) {
  options = _.defaults(options || {}, { force: false });

  options.ajax = _.defaults({ type: 'POST',
                             data : body },
                            options.ajax || {})
